...
setup(
    name='umfactory',
    version=__import__('umfactory').__version__,
    description=__import__('umfactory').__description__,
    long_description=long_description,
    url='https://github.com/noirbizarre/umfactory',
    author='API Hackers',
    author_email='noirbizarre+umfactory@gmail.com',
    ...
    entry_points={
        'pytest11': [
            'umfactory = umfactory.pytest',
        ],
    },
    license='MIT',
    zip_safe=False,
    keywords='umongo motor factory mongo pytest',
    classifiers=[
